 ...
 * @author nhaantran
 */
public class UpdateDiscountt extends javax.swing.JDialog {

    /**
     * Creates new form UpdateDiscountt
     */
    public UpdateDiscountt(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateDiscountt.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                UpdateDiscountt dialog = new UpdateDiscountt(new javax.swing.JFrame(), true);
